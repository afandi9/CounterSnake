...
public class Dice : MonoBehaviour
{
    ...
    private Sprite[] diceSides, diceSides2;
    private SpriteRenderer rend, rend2;
    ...
    private void Start()
    {
        ...
        rend2 = Dice2.gameObject.GetComponent<SpriteRenderer>();
    ...
    private IEnumerator RollTheDice()
    {
        ...
        GameControl.diceSideThrown = (randomDiceSide + 1) + (randomDiceSide2+1);
        Debug.Log("Jumlah dadu = "+GameControl.diceSideThrown);
        //randomDiceSide = 5;
